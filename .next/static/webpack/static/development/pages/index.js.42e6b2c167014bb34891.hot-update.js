...
})(["padding:50px 0;background-color:#f5f5f5;height:80vh;@media (max-width:900px){height:80vh;}"]);
...
})(["display:flex;margin:auto;padding:20px;box-sizing:border-box;@media (max-width:1300px){flex-direction:column;}"]);
...
})(["display:flex;flex:1;flex-direction:column;font-size:52px !important;@media (max-width:1300px){flex-direction:column;width:100%;margin-bottom:50px;}align-items:center;"]);
...
})(["letter-spacing:1.1px;line-height:1.6;font-size:17px;margin-bottom:20px;text-align:justify;color:#62535c;@media (max-width:1300px){width:90%;}"]);
...
})(["flex:2;display:flex;flex-direction:column;@media (max-width:1300px){align-items:center;}"]);
...
//# sourceMappingURL=index.js.42e6b2c167014bb34891.hot-update.js.map