...
})(["padding:50px 0;background-color:#f5f5f5;@media only screen and (max-width:900px){height:80vh;}"]);
...
})(["display:flex;max-width:1224px;align-items:center;margin:auto;padding:20px;align-items:flex-start;box-sizing:border-box;@media only screen and (max-width:1036px){flex-direction:column;}"]);
...
})(["display:flex;flex:1;flex-direction:column;align-items:flex-start;font-size:52px !important;@media only screen and (max-width:1036px){flex-direction:column;width:100%;margin-bottom:50px;}"]);
...
})(["letter-spacing:1.1px;line-height:1.6;font-size:17px;margin-bottom:20px;text-align:justify;color:#62535c;@media only screen and (max-width:900px){width:90%;}"]);
...
})(["flex:2;display:flex;flex-direction:column;width:300px;@media only screen and (max-width:1300px){align-items:center;}"]);
...
//# sourceMappingURL=index.js.469854dc7af3854aa7fb.hot-update.js.map