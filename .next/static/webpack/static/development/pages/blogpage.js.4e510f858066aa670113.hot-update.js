  ...
  _createClass(Blog, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container, {
        ...
        __self: this
      }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_parallax__WEBPACK_IMPORTED_MODULE_10__["Parallax"], (_React$createElement = {
        strength: 500,
        blur: 10,
        bgImageAlt: "the cat"
      }, _defineProperty(_React$createElement, "strength", 200), _defineProperty(_React$createElement, "__source", {
        fileName: _jsxFileName,
        lineNumber: 49
      }), _defineProperty(_React$createElement, "__self", this), _React$createElement), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(SectionHeader, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 50
        },
...
})(["width:300px;height:300px;background-image:url(", ");background-size:cover;background-position:center center;border-radius:100%;box-shadow:0 5px 15px rgba(0,0,0,0.47),0 10px 23px rgba(0,0,0,0.2);background:'white',padding:20,position:'absolute',top:'50%',left:'50%',transform:'translate(-50%,-50%)'"], function (props) {
  return props.image;
});
...
//# sourceMappingURL=blogpage.js.4e510f858066aa670113.hot-update.js.map