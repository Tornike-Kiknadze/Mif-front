...
function (_Component) {
  ...
  function Header(props) {
    ...
    _this.state = {
      lastScroll: 0,
      isScroollingUp: true,
      isOnTop: global.window.scrollY === 0 ? true : false
    };
    return _this;
  }
...
})(["width:100%;height:50px;overflow:hidden;display:flex;align-items:center;justify-content:space-between;padding:0 20px;box-sizing:border-box;position:fixed;top:", ";transition:0.4s;z-index:200;background-color:rgba(255,255,255,0.9);"], function (props) {
...
//# sourceMappingURL=blogpage.js.53f914591e2c5e38921f.hot-update.js.map