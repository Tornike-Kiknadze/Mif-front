...
})(["display:flex;width:1228px;margin:auto;padding:20px;box-sizing:border-box;@media (max-width:1300px){flex-direction:column;width:80%;}"]);
...
})(["display:flex;flex:1;flex-direction:column;background-color:gold;font-size:52px !important;@media (max-width:1300px){flex-direction:column;width:80%;margin-bottom:50px;}align-items:center;"]);
...
//# sourceMappingURL=index.js.571ddbabbe29fbaadb90.hot-update.js.map