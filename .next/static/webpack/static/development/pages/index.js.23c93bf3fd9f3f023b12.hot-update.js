...
})(["padding:50px 0;background-color:#f5f5f5;height:100vh;@media screen and (max-width:900px){height:100vh;}"]);
...
})(["letter-spacing:1.1px;line-height:1.6;font-size:17px;margin-bottom:20px;text-align:justify;color:#62535c;background-color:gold;@media screen and (max-width:900px){background-color:gold;}"]);
...
})(["display:flex;justify-content:flex-start;flex-wrap:wrap;max-width:1228px;margin:auto;"]);
...
//# sourceMappingURL=index.js.23c93bf3fd9f3f023b12.hot-update.js.map