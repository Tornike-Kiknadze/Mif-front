...
})(["display:flex;max-width:1224px;align-items:center;margin:auto;padding:20px;align-items:flex-start;box-sizing:border-box;@media (max-width:1300px){}"]);
...
})(["display:flex;flex:1;flex-direction:column;justify-content:flex-start;font-size:52px !important;@media (max-width:1300px){flex-direction:column;width:100%;margin-bottom:50px;}align-items:center;"]);
...
//# sourceMappingURL=index.js.f6d25a9089b53acc9131.hot-update.js.map