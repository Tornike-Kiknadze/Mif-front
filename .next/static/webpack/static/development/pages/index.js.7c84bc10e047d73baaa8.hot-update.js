...
})(["display:flex;width:1228px;margin:auto;padding:20px;box-sizing:border-box;@media (max-width:1300px){flex-direction:column;}"]);
...
})(["letter-spacing:1.1px;line-height:1.6;font-size:17px;margin-bottom:20px;text-align:justify;color:#62535c;display:flex;@media (max-width:1300px){flex-direction:column;}"]);
...
//# sourceMappingURL=index.js.7c84bc10e047d73baaa8.hot-update.js.map