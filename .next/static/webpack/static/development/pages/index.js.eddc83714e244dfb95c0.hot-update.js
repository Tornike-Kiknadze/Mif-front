...
})(["display:flex;width:1228px;margin:auto;padding:20px;flex-wrap:wrap;border:2px solid gold;box-sizing:border-box;"]);
...
})(["display:flex;flex:1;flex-direction:column;background-color:blue;font-size:52px !important;"]);
...
})(["letter-spacing:1.1px;line-height:1.6;font-size:17px;margin-bottom:20px;text-align:justify;color:#62535c;@media (min-width:1300px){width:100%;}"]);
...
//# sourceMappingURL=index.js.eddc83714e244dfb95c0.hot-update.js.map