...
})(["width:100%;height:55vh;background:#fff5f3;display:flex;flex-direction:column;align-items:center;padding:120px 0;overflow:hidden;position:relative;@media screen and (max-width:998px){text-align:center;line-height:69px;height:35vh;}h1{line-height:55px;letter-spacing:7px;color:#ff7e6d;font-size:65px;margin-top:120px;@media screen and (max-width:998px){text-align:center;line-height:69px;height:35vh;}}span{margin-top:20px;font-size:16px;color:#444053;font-weight:bold;line-height:5px;letter-spacing:2px;}"]);
...
//# sourceMappingURL=index.js.e0d479249bfbfc15934b.hot-update.js.map