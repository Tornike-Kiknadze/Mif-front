...
function (_Component) {
  ...
  function Header(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleScroll", function (e) {
      if (window.scrollY < _this.state.lastScroll) {
        _this.setState({
          isScroollingUp: true
        });
      } else {
  ...
  _createClass(Header, [{
    ...
    value: function componentDidMount() {
      window.addEventListener('scroll', handleScroll(e));
    }
  }, {
    key: "componentWillUnmount",
    value: function componentWillUnmount() {
      window.removeEventListener('scroll', handleScroll(e));
    }
  }, {
    key: "render",
...
//# sourceMappingURL=projects.js.4837afe1e9a6df5f1650.hot-update.js.map