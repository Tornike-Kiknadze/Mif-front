...
})(["width:100%;height:60vh;background:#fff5f3;display:flex;flex-direction:column;align-items:center;padding:120px 0;overflow:hidden;position:relative;@media screen and (max-width:998px){width:100%;text-align:center;line-height:69px;justify-content:center;height:80vh;}h1{line-height:55px;letter-spacing:7px;color:#ff7e6d;font-size:65px;margin-top:120px;@media screen and (max-width:998px){line-height:132px;-webkit-letter-spacing:7px;-moz-letter-spacing:7px;-ms-letter-spacing:7px;letter-spacing:14px;color:#ff7e6d;font-size:130px;}@media screen and (max-width:745px){font-size:90px;}}span{margin-top:20px;font-size:16px;color:#444053;font-weight:bold;line-height:35px;letter-spacing:2px;@media screen and (max-width:998px){width:95%;}@media screen and (max-width:745px){font-size:74px;}}"]);
...
//# sourceMappingURL=index.js.590367a4a331b598ea95.hot-update.js.map