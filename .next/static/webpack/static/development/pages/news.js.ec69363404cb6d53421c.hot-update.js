...
})(["width:1024px;display:grid;grid-template-columns:repeat(4,1fr);grid-template-rows:auto;grid-gap:20px;padding:30px 0;box-sizing:border-box;@media (min-width:30em){grid-template-columns:1fr 1fr;}@media (min-width:60em){grid-template-columns:repeat(4,1fr);}"]);
...
//# sourceMappingURL=news.js.ec69363404cb6d53421c.hot-update.js.map