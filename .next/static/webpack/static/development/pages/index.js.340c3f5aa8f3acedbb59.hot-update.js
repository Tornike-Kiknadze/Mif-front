...
})(["display:flex;flex:1;flex-direction:column;align-items:flex-start;font-size:52px !important;@media screen and (max-width:1036px){align-items:center;width:100%;background-color:red;margin-bottom:50px;}"]);
...
})(["letter-spacing:1.1px;line-height:1.6;font-size:17px;margin-bottom:20px;text-align:justify;color:#62535c;@media screen and (max-width:900px){width:90%;}"]);
...
})(["flex:2;display:flex;flex-direction:column;width:300px;@media screen and (max-width:1300px){align-items:center;background-color:tomato;height:100%;}"]);
...
//# sourceMappingURL=index.js.340c3f5aa8f3acedbb59.hot-update.js.map