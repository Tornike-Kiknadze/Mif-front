...
})(["width:100%;height:100vh;background:#fff5f3;display:flex;flex-direction:column;align-items:center;padding:120px 0;overflow:hidden;justify-content:center;position:relative;@media screen and (max-width:998px){width:100%;text-align:center;line-height:69px;height:80vh;}h1{line-height:55px;letter-spacing:7px;color:#ff7e6d;font-size:65px;margin-top:120px;@media screen and (max-width:998px){margin-top:20px;width:95%;}@media screen and (max-width:745px){font-size:45px;}}span{margin-top:20px;font-size:16px;color:#444053;font-weight:bold;line-height:35px;letter-spacing:2px;@media screen and (max-width:998px){width:95%;}@media screen and (max-width:745px){font-size:14px;}}"]);
...
//# sourceMappingURL=index.js.8c99df30c6dc8ee2a47c.hot-update.js.map